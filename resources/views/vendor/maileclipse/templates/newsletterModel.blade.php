...
<tbody>
<tr>
<td class="pull-left mobile-header-padding-left" style="vertical-align: middle;"><a><img src="https://s3.vortechstudio.test/logos/logo.png" alt="logo" width="180" height="59" /></a></td>
...
<table class="w320" style="height: 144px;" width="600" cellspacing="0" cellpadding="0">
<tbody>
<tr style="height: 36px;">
<td class="header-lg" style="height: 36px; width: 600px;">Welcome to Awesome Inc!</td>
</tr>
<tr style="height: 63px;">
<td class="free-text" style="height: 63px; width: 480px;">Thank you for signing up with awesome co! We hope you enjoy your time with us. Check out some of our newest offers below or the button to view your new account.</td>
</tr>
<tr style="height: 45px;">
<td class="button" style="height: 45px; width: 600px;">
<div><!-- [if mso]>
                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:45px;v-text-anchor:middle;width:155px;" arcsize="15%" strokecolor="#ffffff" fillcolor="#ff6f6f">
                  <w:anchorlock/>
                  <center style="color:#ffffff;font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;">My Account</center>
                </v:roundrect>
              <![endif]--><a class="button-mobile" style="background-color: #ff6f6f; border-radius: 5px; color: #ffffff; display: inline-block; font-family: 'Cabin', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: regular; line-height: 45px; text-align: center; text-decoration: none; width: 155px; -webkit-text-size-adjust: none; mso-hide: all;" href="../../../../../">My Account</a></div>
</td>
</tr>
</tbody>
</table>
