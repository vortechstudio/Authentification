...
@section("content")
    <div class="rounded-3 bg-white p-5 my-10">
        <div class="d-flex flex-column justify-content-center align-items-center w-75 h-300px mx-auto">
            <span class="iconify text-danger mb-5 fs-5qx" data-icon="material-symbols:credit-card-off-outline"></span>
            <span class="fw-bolder fs-2qx mb-1">Paiement Requis</span>
            <span class="fs-1 mb-5">Le paiement doit être effectué</span>
